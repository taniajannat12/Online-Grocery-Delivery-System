...
//         style={{
//           backgroundImage: `url(${groceryImg.src || groceryImg})`
//         }}
//       >
...
const Groceryhome = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section
        className="h-[90vh] bg-cover bg-center bg-no-repeat flex items-center mt-20"
        style={{
          backgroundImage: `url(${groceryImg.src})`
        }}
      >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
            {categories.map((item, index) => (
              <div key={index} className="flex flex-col items-center text-center">
                <div className="w-24 h-24 rounded-full bg-[#eef0e8] flex items-center justify-center hover:scale-105 transition duration-300">
                  <img
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-800 mt-5 leading-tight">
                Fresh Produce Delivered 
              </h2>
              <p className="text-gray-600 text-lg leading-9 mt-8">
                Shop for groceries online and get everything delivered right on
              ...
              <div className="grid grid-cols-4 gap-y-4 gap-x-3 mt-10">
                {["Vegetables", "Fresh Fruit", "Canned Goods", "Dairy Products", "Berries & Nuts", "Dried Fruit", "Bakery", "Beverages"].map((item, index) => (
                  <div key={index} className="flex items-center gap-1">
                    <div className="w-6 h-6 rounded-full bg-lime-500 text-white flex items-center justify-center text-sm font-bold">✓</div>
      ...
      <section className="pt-8 pb-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-center text-lime-500 font-semibold text-lg">How It Works</p>
          <h2 className="text-center text-5xl font-bold text-gray-800 mt-2">Dont Worry, We'll Deliver</h2>
          <p className="text-center text-gray-600 text-xl mt-4 max-w-4xl mx-auto">
            We work with a number of local farms and grocery stores to deliver you the freshest and organic product for your delicious dishes.
          </p>

          <div className="grid md:grid-cols-3 gap-12 mt-14">
            <div className="text-center">
              <img src={chooseImg.src || chooseImg} alt="" className="w-20 mx-auto mb-4" />
              <h3 className="text-3xl font-bold text-black"><span className="text-orange-400">1.</span> Choose Items</h3>
              <p className="text-gray-500 text-lg mt-8 leading-10">Shop online right on this website and select the items you need.</p>
            </div>
            <div className="text-center">
              <img src={orderImg.src || orderImg} alt="" className="w-20 mx-auto mb-4" />
              <h3 className="text-3xl  text-black font-bold"><span className="text-orange-400">2.</span> Place an Order</h3>
              <p className="text-gray-500 text-lg mt-8 leading-10">Add the items to cart and pay for your order online, then specify the delivery time frame.</p>
            </div>
            <div className="text-center">
              <img src={deliveryImg.src || deliveryImg} alt="" className="w-20 mx-auto mb-4" />
              <h3 className="text-3xl  text-black font-bold"><span className="text-orange-400">3.</span> Get Your Delivery</h3>
              <p className="text-gray-500 text-lg mt-8 leading-10">We will deliver your order right in time. We use eco-friendly packaging.</p>
            </div>
          </div>
        </div>
      </section>
