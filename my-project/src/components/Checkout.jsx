            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                ...
                <div className="bg-yellow-50 border border-yellow-300 rounded-xl p-4 mb-5">
                  ...
                  {paymentMethod === "bKash" && (
                    <>
                      <p><strong> Personal:</strong> 01712-345678</p>
                      <p className="text-sm text-gray-600 mt-1">
                        Send the exact amount and enter the Transaction ID.
                      </p>
                    </>
                  )}
                  ...
                  {paymentMethod === "Nagad" && (
                    <>
                      <p><strong>Nagad Personal:</strong> 01812-345678</p>
                      <p className="text-sm text-gray-600 mt-1">
                        Send the exact amount and enter the Transaction ID.
                      </p>
                    </>
                  ...
                  {paymentMethod === "Rocket" && (
                    <>
                      <p><strong>Rocket Personal:</strong> 01912-345678</p>
                      <p className="text-sm text-gray-600 mt-1">
                        Send the exact amount and enter the Transaction ID.
                      </p>
                    </>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full mt-8 bg-green-700 hover:bg-green-800 transition-all duration-300 text-white py-4 rounded-2xl text-lg font-bold shadow-lg disabled:opacity-70"
                >
